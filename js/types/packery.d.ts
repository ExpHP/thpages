...
declare module 'packery' {
  declare interface PackeryOptions
  {
    ...
    */
    ...
    /**
    * [horizontal Arranges items horizontally instead of vertically]
    * @type {boolean}
    */
    horizontal?: boolean;
    ...
    */
    ...
    /**
    * [resize Binds layout to window resizing]
    * @type {boolean}
    */
    resize?: boolean;

    /**
    * [initLayout Enables layout on initialization. Set this to false to disable layout on initialization, so you can use methods or add events before the initial layout]
    * @type {boolean}
    */
    initLayout?: boolean;

    /**
    * [stagger Staggers item transitions, so items transition incrementally after one another. Set as a CSS time format, '0.03s', or as a number in milliseconds, 30.]
    * @type {string | number}
    */
  ...
  export default class Packery {
    constructor(element: Element, config: PackeryOptions);

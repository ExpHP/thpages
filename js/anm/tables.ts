...
/** @this */ // appease eslint
function generateInsTableRowHtml(this: TableHandlers<InsData>, game: Game, ins: InsData, opcode: number) {
...
/** @this */ // appease eslint
function generateVarTableRowHtml(this: TableHandlers<VarData>, game: Game, ins: VarData, opcode: number) {
  const nameKey = getOpcodeNameKey(this, game, opcode);
  let [desc] = handleTipHide(ins.desc, false);
  desc = postprocessAnmDesc(desc, false);
...
export function getDataByRef<D>(ref: string, {mainPrefix, dataTable}: TableHandlers<D>): D {
